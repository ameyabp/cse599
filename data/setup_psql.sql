-- node table creation
create table whale_nodes(_nodeid int, _lat float, _lon float, land_station_floating_factory text, area text, area_max_lat int, area_min_lat int, area_max_lon int, area_min_lon int, ocean text, season int, date date, whale_species text, expedition_code int, expedition_nationality text, owning_company text, expedition_type text);
\copy whale_nodes(_nodeid,_lat,_lon,land_station_floating_factory,area,area_max_lat,area_min_lat,area_max_lon,area_min_lon,ocean,season,date,whale_species,expedition_code,expedition_nationality,owning_company,expedition_type) from /home/ameyap2/Documents/Kyrix/graph_datasets/whaling/graphNodesData.csv delimiter ',' csv header;        -- takes care of date format itself!
...
\copy whale_edges(_edgeid,_srcid,_dstid,_weight,expedition_code,expedition_nationality,owning_company,expedition_type) from /home/ameyap2/Documents/Kyrix/graph_datasets/whaling/graphEdgesData.csv delimiter ',' csv header;
